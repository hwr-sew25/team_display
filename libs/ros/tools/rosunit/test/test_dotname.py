...
class TestDotnameLoading(unittest.TestCase):
    ...
    def test_class_dotname(self):
        rosunit.unitrun(
            "test_rosunit",
            "test_class_dotname",
            "test.dotname_cases.DotnameLoadingTest",
        )
    ...
    def test_method_dotname(self):
        rosunit.unitrun(
            "test_rosunit",
            "test_method_dotname",
            "test.dotname_cases.DotnameLoadingTest.test_a",
        )
    ...
    def test_suite_dotname(self):
        rosunit.unitrun(
            "test_rosunit",
            "test_suite_dotname",
            "test.dotname_cases.DotnameLoadingSuite",
        )
    ...
    def test_class_dotname_nottest(self):
        ...
        with self.assertRaises(TypeError):
            rosunit.unitrun(
                ...
                "test.dotname_cases.NotTestCase",
            )
    ...
    def test_class_dotname_noexist(self):
        ...
        with self.assertRaises(AttributeError):
            rosunit.unitrun(
                ...
                "test.dotname_cases.DotnameLoading",
            )
    ...
    def test_method_dotname_noexist(self):
        ...
        with self.assertRaises(AttributeError):
            rosunit.unitrun(
                ...
                "test.dotname_cases.DotnameLoadingTest.not_method",
            )
