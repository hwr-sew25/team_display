...
try:
    ...
    sys.exit(
        'ImportError: "catkin_pkg.workspaces import get_spaces" failed: %s\nMake sure that you have installed "catkin_pkg", it is up to date and on the PYTHONPATH.'
        % e
    )
try:
    ...
    sys.exit(
        'ImportError: "from catkin_pkg.workspaces import order_paths" failed: %s\nMake sure that you have installed "catkin_pkg", it is up to date and on the PYTHONPATH.'
        % e
    )
...
def main():
    ...
    parser.add_argument(
        "--paths-to-order", nargs="*", help="The semicolon-separated paths to order"
    )
    parser.add_argument(
        "--prefixes",
        nargs="*",
