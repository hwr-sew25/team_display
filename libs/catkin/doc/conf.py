...
try:
    ...
    copyright = "2010-%s, %s" % (time.strftime("%Y"), ", ".join(author_names))
except Exception as e:
    raise RuntimeError(
        "Could not extract version and authors from package.xml:\n%s" % e
    )
...
latex_documents = [
    ("index", "catkin.tex", r"Catkin", r"troy d. straszheim", "manual"),
]
