...
class SimpleUnstableTest(AbstractUnstableTest):
    ...
    def test_make(self):
        ...
        assert_exists(self.builddir, "ros")
        assert_exists(self.develspace, "bin", "etc", "include", "lib", "share")

        assert_exists(self.installdir, "bin", "etc", "include", "lib", "share")
    ...
    def test_common_msgs_against_installed(self):
        ...
        try:
            ...
            shutil.copytree(
                os.path.join(self.workspacedir, "common_msgs"),
    ...
    def test_mock_against_installed(self):
        ...
        try:
            ...
            shutil.copytree(
                os.path.join(MOCK_DIR, "src", "catkin_test"),
                os.path.join(other_src_dir, "catkin_test"),
            )
            self.cmake(
                cwd=other_build_dir, srcdir=other_src_dir, installdir=other_install_dir
            )
            succeed(MAKE_CMD, cwd=other_build_dir)
