...
class TestDotnameLoading(unittest.TestCase):
    ...
    def test_class_dotname(self):
        rostest.rosrun(
            "test_rostest", "test_class_dotname", "dotname_cases.DotnameLoadingTest"
        )
    ...
    def test_method_dotname(self):
        rostest.rosrun(
            "test_rostest",
            "test_method_dotname",
            "dotname_cases.DotnameLoadingTest.test_a",
        )

    def test_suite_dotname(self):
        rostest.rosrun(
            "test_rostest", "test_suite_dotname", "dotname_cases.DotnameLoadingSuite"
        )
    ...
    def test_class_dotname_nottest(self):
        ...
        with self.assertRaises(TypeError):
            rostest.rosrun(
                "test_rostest",
                "test_class_dotname_nottest",
                "dotname_cases.NotTestCase",
            )
    ...
    def test_class_dotname_noexist(self):
        ...
        with self.assertRaises(AttributeError):
            rostest.rosrun(
                "test_rostest",
                "test_class_dotname_noexist",
                "dotname_cases.DotnameLoading",
            )
    ...
    def test_method_dotname_noexist(self):
        ...
        with self.assertRaises(AttributeError):
            rostest.rosrun(
                ...
                "dotname_cases.DotnameLoadingTest.not_method",
            )
