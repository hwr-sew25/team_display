        ...
        try:
            ...
            for i in range(0, length):
                ...
                for i in range(0, length):
                    ...
                    (val2.mesh_use_embedded_materials,) = _get_struct_B().unpack(
                        str[start:end]
                    )
                    val2.mesh_use_embedded_materials = bool(
                        val2.mesh_use_embedded_materials
                    )
                    val1.markers.append(val2)
                start = end
                end += 1
                (val1.independent_marker_orientation,) = _get_struct_B().unpack(
                    str[start:end]
                )
                val1.independent_marker_orientation = bool(
                    val1.independent_marker_orientation
                )
                start = end
                end += 4
                (length,) = _struct_I.unpack(str[start:end])
