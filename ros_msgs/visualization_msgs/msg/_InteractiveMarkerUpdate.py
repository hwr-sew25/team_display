        ...
        try:
            ...
            for val1 in self.markers:
                ...
                for val2 in val1.controls:
                    ...
                    buff.write(
                        _get_struct_3B().pack(
                            _x.orientation_mode, _x.interaction_mode, _x.always_visible
                        )
                    )
    ...
    def deserialize(self, str):
        ...
        try:
            ...
            (
                _x.seq_num,
                _x.type,
            ) = _get_struct_QB().unpack(str[start:end])
            start = end
            end += 4
            (length,) = _struct_I.unpack(str[start:end])
            self.markers = []
            for i in range(0, length):
                ...
                for i in range(0, length):
                    ...
                    (
                        ...
                        _x.interaction_mode,
                        _x.always_visible,
                    ) = _get_struct_3B().unpack(str[start:end])
                    ...
                    for i in range(0, length):
                        ...
                        if python3:
                            val3.mesh_resource = str[start:end].decode(
                                "utf-8", "rosmsg"
                            )
                        else:
                        ...
                        (val3.mesh_use_embedded_materials,) = _get_struct_B().unpack(
                            str[start:end]
                        )
                        val3.mesh_use_embedded_materials = bool(
                            val3.mesh_use_embedded_materials
                        )
                        val2.markers.append(val3)
                    start = end
                    end += 1
                    (val2.independent_marker_orientation,) = _get_struct_B().unpack(
                        str[start:end]
                    )
                    val2.independent_marker_orientation = bool(
                        val2.independent_marker_orientation
                    )
                    start = end
                    end += 4
                    (length,) = _struct_I.unpack(str[start:end])
