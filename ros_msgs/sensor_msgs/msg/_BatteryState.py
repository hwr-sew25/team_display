...
"""
        ...
        try:
            ...
            buff.write(
                _get_struct_7f4B().pack(
                    ...
                    _x.design_capacity,
                    _x.percentage,
                    _x.power_supply_status,
                    _x.power_supply_health,
                    _x.power_supply_technology,
                    _x.present,
                )
            )
    ...
    def deserialize(self, str):
        ...
        try:
            ...
            (
                ...
                _x.power_supply_technology,
                _x.present,
            ) = _get_struct_7f4B().unpack(str[start:end])
    ...
    def deserialize_numpy(self, str, numpy):
        ...
        try:
            ...
            self.cell_voltage = numpy.frombuffer(
            ...
            self.cell_temperature = numpy.frombuffer(
                str[start:end], dtype=numpy.float32, count=length
            )
            start = end
            end += 4
