...
float64 z"""
    ...
    def serialize(self, buff):
        ...
        try:
            ...
            buff.write(
                _get_struct_3d().pack(
                    _x.angular_velocity.x, _x.angular_velocity.y, _x.angular_velocity.z
                )
            )
    ...
    def deserialize(self, str):
        ...
        try:
            ...
            self.linear_acceleration_covariance = _get_struct_9d().unpack(
                str[start:end]
            )
            return self
    ...
    def deserialize_numpy(self, str, numpy):
        ...
        try:
            ...
            self.orientation_covariance = numpy.frombuffer(
            ...
            self.angular_velocity_covariance = numpy.frombuffer(
                str[start:end], dtype=numpy.float64, count=9
            )
            _x = self
            start = end
            ...
            self.linear_acceleration_covariance = numpy.frombuffer(
                str[start:end], dtype=numpy.float64, count=9
            )
            return self
        except struct.error as e:
