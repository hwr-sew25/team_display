...
"""
    ...
    def serialize(self, buff):
        ...
        try:
            ...
            _x = self
            buff.write(
                _get_struct_2i().pack(_x.time_from_start.secs, _x.time_from_start.nsecs)
            )
    ...
    def deserialize_numpy(self, str, numpy):
        ...
        try:
            ...
            self.positions = numpy.frombuffer(
            ...
            self.velocities = numpy.frombuffer(
                str[start:end], dtype=numpy.float64, count=length
            )
            start = end
            end += 4
            ...
            self.accelerations = numpy.frombuffer(
                str[start:end], dtype=numpy.float64, count=length
            )
            start = end
            end += 4
