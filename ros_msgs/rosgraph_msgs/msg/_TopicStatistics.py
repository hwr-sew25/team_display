...
"""
    ...
    def serialize(self, buff):
        ...
        try:
            ...
            _x = self
            buff.write(
                _get_struct_4I15i().pack(
                    _x.window_start.secs,
                    _x.window_start.nsecs,
                    _x.window_stop.secs,
                    _x.window_stop.nsecs,
                    _x.delivered_msgs,
                    _x.dropped_msgs,
                    _x.traffic,
                    _x.period_mean.secs,
                    _x.period_mean.nsecs,
                    _x.period_stddev.secs,
                    _x.period_stddev.nsecs,
                    _x.period_max.secs,
                    _x.period_max.nsecs,
                    _x.stamp_age_mean.secs,
                    _x.stamp_age_mean.nsecs,
                    _x.stamp_age_stddev.secs,
                    _x.stamp_age_stddev.nsecs,
                    _x.stamp_age_max.secs,
                    _x.stamp_age_max.nsecs,
                )
            )
    ...
    def deserialize(self, str):
        ...
        try:
            ...
            (
                ...
                _x.stamp_age_max.secs,
                _x.stamp_age_max.nsecs,
            ) = _get_struct_4I15i().unpack(str[start:end])
