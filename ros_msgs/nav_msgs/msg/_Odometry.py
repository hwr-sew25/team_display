...
float64 z"""
        ...
        try:
            ...
            buff.write(
                _get_struct_7d().pack(
                    ...
                    _x.pose.pose.position.y,
                    _x.pose.pose.position.z,
                    _x.pose.pose.orientation.x,
                    _x.pose.pose.orientation.y,
                    _x.pose.pose.orientation.z,
            ...
            buff.write(
                _get_struct_6d().pack(
                    _x.twist.twist.linear.x,
                    _x.twist.twist.linear.y,
                    _x.twist.twist.linear.z,
                    _x.twist.twist.angular.x,
                    _x.twist.twist.angular.y,
                    _x.twist.twist.angular.z,
                )
            )
    ...
    def deserialize_numpy(self, str, numpy):
        ...
        try:
            ...
            self.pose.covariance = numpy.frombuffer(
            ...
            self.twist.covariance = numpy.frombuffer(
                str[start:end], dtype=numpy.float64, count=36
            )
            return self
        except struct.error as e:
