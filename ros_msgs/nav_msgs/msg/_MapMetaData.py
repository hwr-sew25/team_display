        ...
        try:
            ...
            buff.write(
                _get_struct_2If2I7d().pack(
                    _x.map_load_time.secs,
                    _x.map_load_time.nsecs,
                    _x.resolution,
                    _x.width,
                    _x.height,
                    _x.origin.position.x,
                    _x.origin.position.y,
                    _x.origin.position.z,
                    _x.origin.orientation.x,
                    _x.origin.orientation.y,
                    _x.origin.orientation.z,
                    _x.origin.orientation.w,
                )
            )
