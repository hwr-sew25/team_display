    ...
    def serialize(self, buff):
        ...
        try:
            ...
            buff.write(
                _get_struct_3I().pack(
                    _x.start.header.seq,
                    _x.start.header.stamp.secs,
                    _x.start.header.stamp.nsecs,
                )
            )
            ...
            _x = self
            buff.write(
                _get_struct_7d3I().pack(
                    _x.start.pose.position.x,
                    _x.start.pose.position.y,
                    _x.start.pose.position.z,
                    _x.start.pose.orientation.x,
                    _x.start.pose.orientation.y,
                    _x.start.pose.orientation.z,
                    _x.start.pose.orientation.w,
                    _x.goal.header.seq,
                    _x.goal.header.stamp.secs,
                    _x.goal.header.stamp.nsecs,
                )
            )
            ...
            _x = self
            buff.write(
                _get_struct_7df().pack(
                    _x.goal.pose.position.x,
                    _x.goal.pose.position.y,
                    _x.goal.pose.position.z,
                    _x.goal.pose.orientation.x,
                    _x.goal.pose.orientation.y,
                    _x.goal.pose.orientation.z,
                    _x.goal.pose.orientation.w,
                    _x.tolerance,
                )
            )
    ...
    def deserialize(self, str):
        ...
        try:
            ...
            (
                ...
                _x.goal.pose.orientation.w,
                _x.tolerance,
            ) = _get_struct_7df().unpack(str[start:end])
            return self
