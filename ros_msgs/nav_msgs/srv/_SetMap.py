...
"""
    ...
    def serialize(self, buff):
        ...
        try:
            ...
            buff.write(
                _get_struct_3I().pack(
                    _x.initial_pose.header.seq,
                    _x.initial_pose.header.stamp.secs,
                    _x.initial_pose.header.stamp.nsecs,
                )
            )
            ...
            buff.write(
                _get_struct_7d().pack(
                    _x.initial_pose.pose.pose.position.x,
                    _x.initial_pose.pose.pose.position.y,
                    _x.initial_pose.pose.pose.position.z,
                    _x.initial_pose.pose.pose.orientation.x,
                    _x.initial_pose.pose.pose.orientation.y,
                    _x.initial_pose.pose.pose.orientation.z,
                    _x.initial_pose.pose.pose.orientation.w,
                )
            )
    ...
    def deserialize(self, str):
        ...
        try:
            ...
            if python3:
                self.initial_pose.header.frame_id = str[start:end].decode(
                    "utf-8", "rosmsg"
                )
            else:
    ...
    def deserialize_numpy(self, str, numpy):
        ...
        try:
            ...
            self.map.data = numpy.frombuffer(
                str[start:end], dtype=numpy.int8, count=length
            )
            _x = self
            start = end
            end += 12
            ...
            self.initial_pose.pose.covariance = numpy.frombuffer(
                str[start:end], dtype=numpy.float64, count=36
            )
            return self
        except struct.error as e:
            raise genpy.DeserializationError(e)  # most likely buffer underfill
