...
string name
uint32 count"""
  __slots__ = ['header','period','total_interactions','top_destinations','speech_recognition_rate','average_interaction_time','distance_traveled']
  _slot_types = ['std_msgs/Header','string','uint32','monitor_msgs/DestinationStat[]','float32','float32','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.speech_recognition_rate is None:
        self.speech_recognition_rate = 0.
      if self.average_interaction_time is None:
        self.average_interaction_time = 0.
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.top_destinations:
        ...
        buff.write(_get_struct_I().pack(_x))
      _x = self
      buff.write(_get_struct_3f().pack(_x.speech_recognition_rate, _x.average_interaction_time, _x.distance_traveled))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.speech_recognition_rate, _x.average_interaction_time, _x.distance_traveled,) = _get_struct_3f().unpack(str[start:end])
      return self
