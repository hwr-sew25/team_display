...
"""autogenerated by genpy from movement/TargetPose.msg. Do not edit."""
...
class TargetPose(genpy.Message):
    _md5sum = "09494779bbc297155711bc210cecae33"
    _type = "movement/TargetPose"
    _has_header = True  # flag to mark the presence of a Header object
    _full_text = """Header header 

string target_id        # z.B. "Lobby" oder UUID; leer erlaubt 
...
string frame_id
"""
    __slots__ = ["header", "target_id", "x", "y", "yaw"]
