...
"""autogenerated by genpy from movement/NavStatus.msg. Do not edit."""
...
class NavStatus(genpy.Message):
    _md5sum = "cef0752d1266999d44047d921e15e8a6"
    _type = "movement/NavStatus"
    _has_header = True  # flag to mark the presence of a Header object
    _full_text = """Header header 

uint8 state 

string target_id    #bezieht sich auf das Ziel 
string detail       #freie Zusatzinfo (Fehlercode, Grund etc.)

#States 

uint8 READY=0 
uint8 MOVING_TO_TARGET=1
uint8 ARRIVED=2
uint8 WAITING_FOR_SPEECH=3
uint8 RETURNING_TO_START=4
uint8 AT_START=5
...
"""
    ...
    __slots__ = ["header", "state", "target_id", "detail"]
