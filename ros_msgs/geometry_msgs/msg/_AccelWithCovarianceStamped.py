...
float64 z"""
    ...
    def serialize(self, buff):
        ...
        try:
            ...
            buff.write(
                _get_struct_6d().pack(
                    _x.accel.accel.linear.x,
                    _x.accel.accel.linear.y,
                    _x.accel.accel.linear.z,
                    _x.accel.accel.angular.x,
                    _x.accel.accel.angular.y,
                    _x.accel.accel.angular.z,
                )
            )
    ...
    def deserialize_numpy(self, str, numpy):
        ...
        try:
            ...
            self.accel.covariance = numpy.frombuffer(
