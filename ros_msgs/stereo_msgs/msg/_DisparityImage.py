...
"""
    ...
    def serialize(self, buff):
        ...
        try:
            ...
            _x = self
            buff.write(
                _get_struct_2f4IB3f().pack(
                    _x.f,
                    _x.T,
                    _x.valid_window.x_offset,
                    _x.valid_window.y_offset,
                    _x.valid_window.height,
                    _x.valid_window.width,
                    _x.valid_window.do_rectify,
                    _x.min_disparity,
                    _x.max_disparity,
                    _x.delta_d,
                )
    ...
    def deserialize(self, str):
        ...
        try:
            ...
            (
                ...
                _x.max_disparity,
                _x.delta_d,
            ) = _get_struct_2f4IB3f().unpack(str[start:end])
